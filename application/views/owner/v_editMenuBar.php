        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-gray-800">Edit Menu Bar</h1>
                    <?php foreach($menu_bar as $u): ?>
                      <form action="<?= base_url(). 'owner/editMenuBar';  ?>" method="post">
                        <div class="form-group row">
                            <label for="formGroupExampleInput" class="col-sm-2 col-form-label">ID</label>
                          <div class="col-sm-10">
                            <input disabled type="text" class="form-control" name="id_menu" id="formGroupExampleInput" value="<?php echo $u->id_menu ?>" placeholder="">
                            <input hidden type="text" class="form-control" name="id_menu" id="formGroupExampleInput" value="<?php echo $u->id_menu ?>" placeholder="">
                          </div>
                        </div>
                        <div class="form-group row">
