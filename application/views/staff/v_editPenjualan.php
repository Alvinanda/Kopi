 ...
 <div class="main-content-container container-fluid px-4">
    ...
    <div class="col-12 col-sm-6 text-center text-sm-left mb-4 mb-sm-0">
        <span class="text-uppercase page-subtitle">Ubah Data Penjualan</span>
...
<div class="row">
    <div class="col-lg-9 col-md-12">
        ...
        <div class="">
            ...
            <form action="<?php echo base_url(). 'staff/editPenjualan'; ?>" method="post">
              <div class="form-group">
                <div class="form-group col-md-6">
                  <label for="formGroupExampleInput">ID</label>
                  <input disabled type="text" class="form-control" name="id_penjualan" id="formGroupExampleInput" value="<?php echo $u->id_penjualan ?>" placeholder="">
                  <input hidden type="text" class="form-control" name="id_penjualan" id="formGroupExampleInput" value="<?php echo $u->id_penjualan ?>" placeholder="">
                </div>
              </div>
                <div class="form-row">
                    <div class="form-group col-md-6">
                ...
                <div class="form-group">
                    ...
                    <input name="nama_pembeli" type="text" class="form-control" list="cars" id="feLastName"  value="<?php echo $u->nama_pembeli ?>">
                    <?php foreach ($member as $x ): ?>
                      <datalist id="cars">
                          <option> <?= $x->nama ?> </option>
                        </datalist>
                    <?php endforeach; ?>
                </div>
                <div class="form-row">
                <div class="form-group col-md-4">
                    ...
                    <select name="star_member" id="feInputState" class="form-control">
                        <option selected><?php echo $u->star_member ?></option>
                ...
                <div class="form-row">
                    ...
                    <select name="status" id="feInputState" class="form-control">
                        <option selected><?php echo $u->status ?></option>
